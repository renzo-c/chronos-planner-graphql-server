...
const db = new _sequelize.default(process.env.DB_NAME, process.env.DB_USER, process.env.DB_PASSWORD, {
...
const Employee = db.define("employee", _Employee.default);
const Schedule = db.define("schedule", _Schedule.default);
const Attendance = db.define("attendance", _Attendance.default); // Associations
